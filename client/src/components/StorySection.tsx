...
// Story images
const storyImage1 = 'https://res.cloudinary.com/dsan7eodz/image/upload/v1763385235/HOW_WE_MET_xmnpnp.jpg';
const storyImage2 = 'https://res.cloudinary.com/dsan7eodz/image/upload/v1763385236/OCEANS_APART_a4fvwg.jpg';
const storyImage3 = 'https://res.cloudinary.com/dsan7eodz/image/upload/v1763385235/GOD_PERFECT_TIMING_mrbhdr.jpg';
  ...
  const storyCards = [
    {
      id: 1,
      title: "How We Met:",
      text: "Our paths first crossed on June 1, 2021 through my coworker—his cousin—and from that very next day, our love story began to bloom, nurtured by shared faith and a heart for service.",
      image: storyImage1,
      icon: Heart
    },
    {
      id: 2, 
      title: "Oceans Apart:",
      text: "Though miles and oceans lay between us, love bridged the distance, and with every challenge, our hearts grew closer, always moving as one.",
      image: storyImage2,
      icon: Gem
    },
    {
      ...
      text: "Today we celebrate a promise made possible by God's grace. With Him at the center, we step into the future together, promising to walk hand in hand through every season.",
      image: storyImage3,
      icon: Church
    }
  ];
            ...
            <div className="max-w-4xl mx-auto text-center relative">
              ...
              <div className="relative z-10 space-y-6 sm:space-y-8">
                ...
                <div className="max-w-2xl mx-auto">
                  <p className="text-lg sm:text-xl leading-relaxed italic text-foreground/95 whitespace-pre-line">
                    With this solemn vow{'\n'}
                    I take thee{'\n'}
                    For what you are{'\n'}
                    With what I am{'\n'}
                    With what I have{'\n'}
                    All the blessings we shall share{'\n'}
                    All the trials we shall face together{'\n'}
                    Life by our own has ended{'\n'}
                    And so has mine{'\n'}
                    Yet we still live{'\n'}
                    For we have just began.
                  </p>
                </div>
