...
const TimelineCard: React.FC<TimelineCardProps> = ({ timelineEvent, i }) => {
    ...
    const getEventDescription = (eventName: string): string => {
        const descriptions: Record<string, string> = {
            "Departure to Church": "We highly encourage you to arrive an hour before the ceremony starts. Please be seated by 4:00 PM",
            "Wedding Ceremony": "Witness our vows and the beginning of our journey together as we exchange rings and promises at The Diocesan Shrine and Parish of Our Lady of the Abandoned",
            "Sequence Pictorial": "Capture beautiful moments with the newlyweds and wedding party. Professional photography session for cherished memories",
            "Cocktail Hour": "Relax and mingle with other guests while enjoying refreshing drinks and light appetizers",
            "A Night to Remember": "Join us at Teodore Events Place for dinner, heartfelt toasts, and dancing as we celebrate our union together",
            "Send Off": "Say goodbye as we close the night with love, gratitude, and blessings"
        };
